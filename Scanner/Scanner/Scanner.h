...
struct Scanner{
    ...
    char buffer[BUFFSIZE*2];//,buffer2[BUFFSIZE+1];
    ...
    //This are variables that could be on version 2
    int input, inputPos, fence;
    std::string lexeme;
    std::stack<State>  stack;
    std::set<std::pair<State, int>> failed;
    ...
    std::map<std::pair<State,char>, State> nextState={
            {std::make_pair(q0,'\000'),qEOF},//
            {std::make_pair(qLT,'#'),qBComm},//
            {std::make_pair(qBComm,'#'),qBCommHash},//
            {std::make_pair(qBCommHash,'>'),q0},//
            {std::make_pair(q0,' '),q0},//
            {std::make_pair(q0,'\t'),q0},//
            {std::make_pair(q0,'\n'),q0},//
            ...
            {std::make_pair(qconi,'u'),qconiu},
            {std::make_pair(qconiu,'g'),qconiug},
            {std::make_pair(qconiug,'o'),qconiugo},
           ...
           // {std::make_pair(qLT,'#'),qLT_Hash},
            ...
            {std::make_pair(q0,'('),qPI},
            {std::make_pair(q0,')'),qPD}
    ...
    std::map<State, Token> tokens={
            //{q0, Token(t_error,0)},
            {qNumRom, Token(t_literalEntero,3)},
            {qNumDec, Token(t_literalEntero,1)},
            {qNumHex, Token(t_literalEntero,2)},
            {qEOF, Token(t_EOF)},
            ...
            {qcommut,Token(t_ID)},
            {qcommuta,Token(t_ID)},
            {qcommutab,Token(t_ID)},
            {qcommutabi,Token(t_ID)},
            {qcommutabil,Token(t_ID)},
            {qcommutabili,Token(t_ID)},
            {qcon,Token(t_ID)},
            {qconi,Token(t_ID)},
            {qconiu,Token(t_ID)},
            {qconiug,Token(t_ID)},
            ...
            {qdetrim,Token(t_ID)},
            {qdetrime,Token(t_ID)},
            {qdetrimen,Token(t_ID)},
            {qdetriment,Token(t_ID)},
            {qdetrimentu,Token(t_ID)},
            {qdec,Token(t_ID)},
            {qdecr,Token(t_ID)},
            {qdecre,Token(t_ID)},
            {qdecrem,Token(t_ID)},
            {qdecreme,Token(t_ID)},
            {qdecremen,Token(t_ID)},
            {qdecrement,Token(t_ID)},
            {qdecrementu,Token(t_ID)},
            {qdi,Token(t_ID)},
            {qdir,Token(t_ID)},
            {qdire,Token(t_ID)},
            {qdirec,Token(t_ID)},
            ...
            {qfalsid,Token(t_ID)},
            {qfalsidi,Token(t_ID)},
            {qfalsidic,Token(t_ID)},
            {qfalsidicu,Token(t_ID)},
            {qfi,Token(t_ID)},
            {qfir,Token(t_ID)},
            {qfirm,Token(t_ID)},
            {qfirma,Token(t_ID)},
            {qfirmam,Token(t_ID)},
            {qfirmame,Token(t_ID)},
            {qfirmamen,Token(t_ID)},
            {qfirmament,Token(t_ID)},
            {qfirmamentu,Token(t_ID)},
            {qfin,Token(t_ID)},
            {qfini,Token(t_ID)},
            {qfr,Token(t_ID)},
            {qfra,Token(t_ID)},
            ...
            {qfuribu,Token(t_ID)},
            {qfuribun,Token(t_ID)},
            {qfuribund,Token(t_ID)},
            {qfuribundu,Token(t_ID)},
            {qi,Token(t_ID)},
            {qig,Token(t_ID)},
            {qim,Token(t_ID)},
            {qima,Token(t_ID)},
            ...
            {qincrem,Token(t_ID)},
            {qincreme,Token(t_ID)},
            {qincremen,Token(t_ID)},
            {qincrement,Token(t_ID)},
            {qincrementu,Token(t_ID)},
            {qini,Token(t_ID)},
            {qinit,Token(t_ID)},
            {qinitu,Token(t_ID)},
            {qit,Token(t_ID)},
            ...
            {qpatent,Token(t_ID)},
            {qpatenti,Token(t_ID)},
            {qpatentib,Token(t_ID)},
            {qpatentibu,Token(t_ID)},
            {qpe,Token(t_ID)},
            {qper,Token(t_ID)},
            {qperp,Token(t_ID)},
            {qperpe,Token(t_ID)},
            ...
            {qscript,Token(t_ID)},
            {qscriptu,Token(t_ID)},
            {qscriptur,Token(t_ID)},
            {qscriptura,Token(t_ID)},
            {qsi,Token(t_ID)},
            {qsig,Token(t_ID)},
            {qsigl,Token(t_ID)},
            {qsu,Token(t_ID)},
    ...
    void JumpToSafePoint();

    bool isValidCharForIDs(char c);
