...
#ifndef SCANNER_PRETTYPRINTING_H
#define SCANNER_PRETTYPRINTING_H

#include <string>
#include "Scanner/Scanner.h"

static std::map<TokenType, std::string> colorTable ={
        {t_aeger, "00FFFF"},
        {t_asignador, "DC143C"},
        {t_atomico, "98FB98"},
        {t_auctum, "FFD700"},
...
#endif //SCANNER_PRETTYPRINTING_H
